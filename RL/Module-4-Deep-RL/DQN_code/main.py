...
# make directory
if not os.path.exists("DQN_code/saved_pickle_files"):
    os.mkdir("DQN_code/saved_pickle_files")

# save rewards_per_episode
save_pickle(rewards_per_episode, "DQN_code/saved_pickle_files/rewards_per_episode")


# plot results
with open('DQN_code/saved_pickle_files/rewards_per_episode.pkl', 'rb') as f:
...
plt.savefig('DQN_code/rewards.png')
